...
class GameGrid(Frame):
    def __init__(self):
        ...
        self.commands = {
            c.KEY_UP: funcs.up,
            c.KEY_DOWN: funcs.down,
            c.KEY_LEFT: funcs.left,
            c.KEY_RIGHT: funcs.right,
            c.KEY_UP_ALT1: funcs.up,
            c.KEY_DOWN_ALT1: funcs.down,
            c.KEY_LEFT_ALT1: funcs.left,
            c.KEY_RIGHT_ALT1: funcs.right,
            c.KEY_UP_ALT2: funcs.up,
            c.KEY_DOWN_ALT2: funcs.down,
            c.KEY_LEFT_ALT2: funcs.left,
            c.KEY_RIGHT_ALT2: funcs.right,
        }
